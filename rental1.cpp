...
{
	ifstream fin;
	fin.open("costumer.txt",ios::in|ios::binary);
	cout<<"------------------------------------------------------------------------------------------------------------------------"<<endl;
...
void show_clas()
{
	...
	int flag=0;
	ifstream fin;
	fin.open("costumer.txt",ios::binary|ios::out);
...
void delt()
{
	...
	ofstream w;
	fin.open("costumer.txt",ios::binary|ios::out);
	w.open("Newcostumer.txt",ios::binary|ios::app|ios::out);
	...
	w.close();
	remove("costumer.txt");
	rename("Newcostumer.txt","costumer.txt");
	if(flag==0)
	{
		cout<<"\n.....Admission No. Not Found.....\n";
	}
...
void modify()
{
	...
	fin.open("costumer.txt",ios::in|ios::binary|ios::out);
...
void in_mark()
{
    ...
    if(flag)
	{
		int a ;
		fstream fmcostumer;
		fmcostumer.open("markreservation.txt",ios::in|ios::binary|ios::out);
		set[v].get_mark();
		fmcostumer.write((char*)&set,sizeof(set));
		fmcostumer.close();
	}
	else
	{
...
void disply_mark()
{
	...
	cin>>a;
	ifstream fin;
	fin.open("markreservation.txt",ios::in|ios::binary);
	cout<<"------------------------------------------------------------------------------------------------------------------------"<<endl;
...
void delet()
{
	...
	ifstream fin;
	ofstream w;
	fin.open("markreservation.txt",ios::binary|ios::out);
	w.open("tempreservation.txt",ios::binary|ios::app|ios::out);
	...
	w.close();
	remove("markreservation.txt");
	rename("tempreservation.txt","markreservation.txt");
	if(flag==0)
	{
		cout<<"\n.....Admission No. Not Found.....\n";
	}
...
void modif()
{
	...
	fin.open("markreservation.txt",ios::in|ios::binary|ios::out);
...
int first::admin_view()
{
	...
	do
	{
		...
		<<"||2.Show Costumer.         ||\n\t\t\t||\t\t\t   ||8.Show Reservations.\n\t\t\t"
		<<"||3.Today's Reservation.   ||\n\t\t\t||\t\t\t   ||9.Delete Reservation.\n\t\t\t"
		<<"||4.Search Costumer data.  ||\n\t\t\t||\t\t\t   ||10.Modify Reservation.\n\t\t\t"
