...
class BucketList* createBucket(int V)
{
	int i;
	class BucketList* bl = new BucketList;
...
void addNode(class BucketList* bl, int bckt, int value)
{
	...
	class Node *newnode = newNode(value);
...
int main()
{
	...
	class BucketList* mybucket = createBucket(V);
